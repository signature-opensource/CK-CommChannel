...
public enum Handshake
{
    ...
    None = 0,
    /// <summary>
    /// The XON/XOFF software control protocol is used. The XOFF control is sent to stop the transmission of data.
    /// The XON control is sent to resume the transmission. These software controls are used instead of Request to Send (RTS) and Clear to Send (CTS) hardware controls.
    /// </summary>
    XOnXOff = 1,
    /// <summary>
    /// Request-to-Send (RTS) hardware flow control is used. RTS signals that data is available for transmission.
